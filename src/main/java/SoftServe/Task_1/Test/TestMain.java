...
import static SoftServe.Task_1.IO.Validators.SelfFormatValidator.validReport;
...
public class TestMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String report = "sdfssdfsdfsdf";

        System.out.println(validReport(report));
        System.out.println(first.getName().length()<2);
